...
load(file="rdata/mps.ftune.sbr1000.rdata",verbose=T)
...
library(doParallel)
library(FLRef)
load("~/mseLite/mse_refpts/rdata/inpMP.sbr.1000.rdata",verbose=T)
length(hcrs$target)
# Run in batches
...
save(stks ,file=paste0("~/mseLite/mse_refpts/rdata/mps.ftune.sbr1000.rdata"))
