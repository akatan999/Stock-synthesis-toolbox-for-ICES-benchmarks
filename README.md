...
For this, you should use Install packages for stock synthesis benchmark.Rmd
...
10.	Identify parameters that changes most when running the retro (Retro_sensitivity.R)

More additional diagnostics

11. NUTS MCMC.R run MCMC both with RWM and NUTS algorithms for your best case model
