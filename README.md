...
1.	Run script (1. Ensemble_grid_Lobster3a_example.R) for creating the models grid diagnostic table (1. Ensemble_grid_Northern Seabass_example.R); it creates the diags table and some plots of the next script
